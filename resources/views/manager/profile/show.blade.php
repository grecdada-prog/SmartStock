                ...
                <form method="POST" action="{{ route('account.profile.password.update') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" name="current_password" id="current_password" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm @error('current_password') border-red-300 @enderror">
                    ...
                    <div>
                        @if($user->google2fa_enabled)
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                <svg class="-ml-1 mr-1.5 h-5 w-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    @if($user->google2fa_enabled)
                        <form method="POST" action="{{ route('2fa.disable') }}" class="inline">
                            ...
                            <input type="password" name="password" placeholder="Mot de passe" required
                                class="mr-2 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">
                            <button type="submit"
