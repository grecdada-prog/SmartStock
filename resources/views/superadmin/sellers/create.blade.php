...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('superadmin.sellers.store') }}" class="space-y-6 p-6">
                @csrf
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Permissions du Vendeur</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Accès au point de vente (POS)</li>
                                    <li>Enregistrement des ventes</li>
                                    <li>Consultation de l'historique de ses ventes</li>
                                    <li>Consultation des produits disponibles</li>
                                </ul>
                            </div>
                        </div>
                    </div>
