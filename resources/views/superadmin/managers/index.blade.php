                            ...
                            @forelse($managers as $manager)
                                <tr>
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <x-action-menu>
                                            <a href="{{ route('superadmin.managers.edit', $manager) }}" class="flex w-full items-center rounded-md px-3 py-2 text-left text-sm font-medium text-blue-700 transition hover:bg-blue-50 focus:bg-blue-50 focus:outline-none">
                                                Modifier
                                            </a>
...
<x-modal-confirm
    ...
    message="Êtes-vous sûr de vouloir supprimer ce gérant ? Cette action est irréversible."
