<div wire:poll.30s="loadStats">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="text-3xl font-bold text-green-600">{{ number_format($todaySales) }} FCFA</div>
        </div>
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="text-gray-500 text-sm">Stock Faible</div>
            <div class="text-3xl font-bold text-orange-600">{{ number_format($lowStockProducts) }}</div>
        </div>
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="text-gray-500 text-sm">Vendeurs Actifs</div>
            <div class="text-3xl font-bold text-blue-600">{{ $activeSellers }} / {{ $totalSellers }}</div>
        </div>
    </div>
