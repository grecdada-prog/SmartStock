<div wire:poll.30s="loadStats">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="text-3xl font-bold text-green-600">{{ number_format($mySalesToday) }} FCFA</div>
        </div>
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="text-gray-500 text-sm">Nombre de Transactions</div>
            <div class="text-3xl font-bold text-blue-600">{{ number_format($myTransactionsCount) }}</div>
        </div>
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="text-gray-500 text-sm">Produits Disponibles</div>
            <div class="text-3xl font-bold text-gray-900">{{ number_format($availableProducts) }}</div>
        </div>
    </div>
