    ...
    <div class="bg-white shadow rounded-lg p-4 border border-gray-200">
        <form method="GET" data-auto-filter action="{{ route('seller.sales.history') }}" class="space-y-4">
            ...
            <div class="flex gap-2 flex-wrap">
                <button type="button" onclick="document.getElementById('search').value=''; document.getElementById('payment_method').value=''; document.getElementById('date_from').value=''; document.getElementById('date_to').value=''; this.closest('form').submit();" class="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium bg-white text-gray-700 hover:bg-gray-50 border border-gray-300">Tout</button>
